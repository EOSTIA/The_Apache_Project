package com.student.inventory.kafka;

import com.student.inventory.crypto.AesGcmEncryptor;
...
/**
 * Listens on config.inventory, decrypts each incoming value, and writes it
...
public class ConfigConsumer 
{
    ...
    public void onConfigMessage(String rawJson) 
    {
        ...
        {
            System.err.println("[inventory] Skipping malformed message: " + rawJson);
            return;
        }
        ...
        System.out.println("[inventory] Applied config update: " + key + " = " + plainValue);
    }
