...
/**
 * This java file declares the three config topics on startup. Spring Kafka will create them
 ...
 *
 * One topic per service : each microservice only subscribes to its own topic,
 * so there's no filtering logic needed on the consumer side.
 */
@Configuration
